...
Locales['fr'] = {
    ...
    ['craft_knowledge_unlearned'] = 'Connaissance non apprise',
    ['craft_skills_loading'] = 'Chargement des savoirs...',
    ['craft_skill_required'] = 'Savoir requis : %s',
    ...
    ['craft_debug_give_ok'] = 'Matériaux donnés : %s',
    ['craft_debug_give_none'] = 'Aucun matériau manquant',
    ['craft_debug_give_partial'] = 'Inventaire plein — donné : %s',
    ...
    ['queue_full'] = 'File de production pleine',
    ['queue_added'] = 'Ajouté à la file',
    ...
    ['craft_output_ready'] = 'Production terminée / %s x%s / Disponible à la %s.',
