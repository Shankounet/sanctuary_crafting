--[[
    ...
    Manuel de terrain personnel. Progression = lecture seule via CraftingSkills / sanctuary_skilltree.
]]
...
Config.Book = {
    ...
    -- Carnet SFX: soft paper open/page/close only (no electronic beeps) — v2.28.0
    Sounds = {
        Enabled = true,
        Volume = 0.2,  -- softer than UI default; inherits Files from Config.UI.Sounds when absent
    },
    LazyLoad = true,
    MaxPins = 8,
    MaxNotes = 64,
    ...
    Progression   = { Enabled = true }, -- READ-ONLY sanctuary_skilltree (Niveau + XP, pas de barre % inventée)
