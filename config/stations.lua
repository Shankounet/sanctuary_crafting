...
Config.Stations = {
    ...
    Upgrades = {
        -- 18 real stations
        armurier = ups('gunsmith'),
        munition = ups('gunsmith'),
        survie = ups('survival'),
        tailleur = ups('survival'),
        forgeron = ups('engineer'),
        reparation_forgeron = ups('engineer'),
        medical = ups('medic'),
        agriculture = ups('survival'),
        boucherie = ups('survival'),
        ingenieur = ups('engineer'),
        mecano = ups('engineer'),
        cuisine = ups('survival'),
        fonderie_forgeron = ups('engineer'),
        manche_forgeron = ups('engineer'),
        construction = ups('engineer'),
        decoration = ups('engineer'),
        schema = ups('engineer'),
        accessoires = ups('gunsmith'),
        -- legacy
        scrap = ups('engineer'),
        weapons = ups('gunsmith'),
        survival = ups('survival'),
        mechanic = ups('engineer'),
    },
    Condition = {
        Enabled = true,
